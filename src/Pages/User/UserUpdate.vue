<template>
  <template v-if="user">
    <div>
      ...
      <van-cell icon="contact-o" title="头像" is-link to="/upload">
    </van-cell>
      ...
      <van-cell icon="user-circle-o"  is-link to="/user/edit" :value="user.username" @click="toEdit('username','昵称',user.username)">
        <template #title>
      ...
      <van-cell icon="like-o" is-link :value="user.gender" @click="toEdit('gender','性别',user.gender)">
        <template #title>
